...
import transcriptDataEN from '@/../public/w1_transcripts/EN.json';
import transcriptDataDE from '@/../public/w1_transcripts/DE.json';
import transcriptDataNL from '@/../public/w1_transcripts/NL.json';
...
function CourseContent() {
  const t = useTranslations('W1CoursePage');
  ...
  const chapterCards = [
    ...
    },
    {
      ...
      link: `${currentPath}/open-questions`,
      icon: 'goal',
    },
  ];
  ...
  const videoData = {
    src: {
      en: process.env.NEXT_PUBLIC_MANIFEST_EN_VIDEO1 || '',
      nl: process.env.NEXT_PUBLIC_MANIFEST_NL_VIDEO1 || '',
      de: process.env.NEXT_PUBLIC_MANIFEST_DE_VIDEO1 || '',
    },
    poster: process.env.NEXT_PUBLIC_POSTER_URL_VIDEO1 || '',
    subtitles: {
      en: process.env.NEXT_PUBLIC_SUBTITLES_EN_VIDEO1 || '',
      nl: process.env.NEXT_PUBLIC_SUBTITLES_NL_VIDEO1 || '',
      de: process.env.NEXT_PUBLIC_SUBTITLES_DE_VIDEO1 || '',
    },
    download: {
      en: process.env.NEXT_PUBLIC_DOWNLOAD_EN_VIDEO1 || '',
      nl: process.env.NEXT_PUBLIC_DOWNLOAD_NL_VIDEO1 || '',
      de: process.env.NEXT_PUBLIC_DOWNLOAD_DE_VIDEO1 || '',
    },
  };
  ...
  const resourcesData: WebinarResourcesProps = {
    en: {
      items: [
        {
          link: '/bibliography#w1-literature',
